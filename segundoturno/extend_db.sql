...
INSERT INTO urna (SG_UF,CD_MUNICIPIO,NM_MUNICIPIO,MODELO,NR_ZONA,NR_SECAO,NR_LOCAL_VOTACAO,IS_CAPITAL,DT_CARGA_URNA_EFETIVADA,DT_ABERTURA,DT_ENCERRAMENTO,DT_EMISSAO_BU,DT_BU_RECEBIDO,QT_APTOS,QT_COMPARECIMENTO,QT_ABSTENCOES,votos_lula,votos_bozo,votos_nulo,votos_branco,votos_totais)
SELECT SG_UF,CD_MUNICIPIO,NM_MUNICIPIO,MODELO,NR_ZONA,NR_SECAO,NR_LOCAL_VOTACAO,IS_CAPITAL,DT_CARGA_URNA_EFETIVADA,DT_ABERTURA,DT_ENCERRAMENTO,DT_EMISSAO_BU,DT_BU_RECEBIDO,QT_APTOS,QT_COMPARECIMENTO,QT_ABSTENCOES,votos_lula,votos_bozo,votos_nulo,votos_branco,votos_totais
FROM resumo;
